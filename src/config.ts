...
export const siteConfig: SiteConfig = {
	title: "七鹰",
	subtitle: "Operation",
	siteURL: "https://patchouli.tech/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "628945351", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/Lagrange.webp"
				/*
			...
			mobile: [
				"/assets/mobile-banner/Lagrange.webp"
				/*
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "sevneagle/sevneagle.github.io",
		repoId: "R_kgDOQw_EvA",
		category: "Announcements",
		categoryId: "DIC_kwDOQw_EvM4C92oO",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const sidebarLayoutConfig: SidebarLayoutConfig = {
	...
	// 侧栏组件布局配置
	components: {
		left: ["profile", "announcement", "tags", "calendar"],
		right: ["site-stats","card-toc" /*"calendar" , "categories", "music-sidebar"*/],
		drawer: [
			"profile",
			"announcement",
			/*"music-sidebar",*/
