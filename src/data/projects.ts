...
export const projectsData: Project[] = [
	{
		...
		description:
			"八个按键的神秘机台",
		image: "/images/projects/dick.webp",
		category: "other",
		techStack: ["game"],
		status: "planned",
...
//		visitUrl: "https://blog.example.com", // 添加前往项目链接
	...
	},
	{
		...
		status: "in-progress",
//		liveDemo: "https://blog.example.com",
		sourceCode: "https://github.com/Sevneagle/sevneagle.github.io", // 更改为GitHub链接
		visitUrl: "https://patchouli.group", // 添加前往项目链接
